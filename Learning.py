    ...
    def load_model(self):
        ...
        for m in self.algo_dict.keys():
            ...
            if m == 'XGBRegressor':
                # XGBRegressor
                scoring = ["neg_mean_absolute_error", "neg_mean_squared_error"]
                #p_grid = {"learning_rate": [0.05, 0.075, 0.1, 0.2], "max_depth": [5, 20, 100, 200, 400], "n_estimators": [20, 50, 100, 200, 300, 400]}
                p_grid = {"learning_rate": [0.15, 0.25], "max_depth": [5, 20, 50], "n_estimators": [25, 50, 100]}
                model = XGBRegressor()
